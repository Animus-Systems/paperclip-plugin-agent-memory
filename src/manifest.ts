  ...
  tools: [
    {
      ...
      description:
        ...
        "Use at the start of a task to check for prior decisions, learnings, or facts. " +
        "Also useful mid-task when you need context about people, projects, or past work.",
      parametersSchema: {
        type: "object",
        properties: {
          query: {
    ...
    },
    {
      ...
      description:
        ...
        "Use when you discover something that should persist — decisions made, facts found, approaches that worked or failed.",
      parametersSchema: {
        type: "object",
        properties: {
          content: {
